...
<body>
  ...
  <div class="home-section"> 
    ...
    <form method="POST">
      <div class="titre"><h2> Paramètre de Compte </h2>
                </div>
...
<!--                            
                    ...
                    <i id="hide5" class="fa-light fa-eye"></i>
                                <i id="hide6" class="fa-light fa-eye-slash"></i> </span>-->
                        ...
                        <tr>
                            ...
                            <td>
                              <div class="Set">
                                ...
                                <i id="hide2" class="fa-light fa-eye-slash"></i> </span>-->
                              </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <td>
                          <div  class="Set"> <input id='conf' required type="password" name="confirmation">
                                ...
                                <i id="hide4" class="fa-light fa-eye-slash"></i> </span>-->
                      </div>
                    ...
                    <tr>
                      <td>
                       <a href="Gest.php" style="vertical-align:middle" id="btn1"><span>Gérer Les Comptes</span> </a>
                      </td>
                    </tr>
                    ...
                    <input class="Enrg" type="submit" value="Enregistrer" name="enregister"/>
